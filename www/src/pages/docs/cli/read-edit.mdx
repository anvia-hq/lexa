...
| `--content-file <path>` | Read replacement content from a file. Prefer this for large Markdown, full-block replacements, or content with shell metacharacters. |
...
For large replacements, write the new body to a temporary file and pass
`--content-file`; this avoids brittle shell quoting for Markdown, code fences,
backticks, and multi-line content.
